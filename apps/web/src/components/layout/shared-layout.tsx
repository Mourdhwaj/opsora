...
export function SharedLayout({ children, navItems, portalLabel }: SharedLayoutProps) {
      ...
      >
        ...
        <div className="h-16 flex items-center gap-3 px-5 border-b border-border flex-shrink-0">
          ...
          <div>
            ...
            <span className="block text-[10px] text-ink-muted -mt-0.5">{portalLabel}</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-surface border-b border-border flex items-center justify-between px-4 lg:px-8 flex-shrink-0 sticky top-0 z-30">
          <button
            ...
            className="lg:hidden p-2 -ml-2 text-ink-secondary hover:text-ink"
          >
