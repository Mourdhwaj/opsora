...
const styles = StyleSheet.create({
  ...
  editBtnText: { color: theme.colors.primary, fontSize: 13, fontFamily: theme.font.semiBold },
  detailsCard: { marginBottom: 16 },
  sectionTitle: { fontSize: 16, fontFamily: theme.font.bold, color: theme.colors.text, marginBottom: 12 },
  detailRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: theme.colors.borderLight },
  ...
  sheetTitle: { fontSize: 20, fontFamily: theme.font.extraBold, color: theme.colors.text, marginBottom: 16 },
