...
function getStatusColor(s: string): string {
  const m: Record<string, string> = { pending: '#f59e0b', in_progress: '#3b82f6', completed: '#22c55e' };
  return m[s] || '#6b7280';
}

function getPriorityColor(p: string): string {
  const m: Record<string, string> = { urgent: '#dc2626', high: '#f97316', medium: '#eab308', low: '#3b82f6' };
  return m[p] || '#6b7280';
}
...
const styles = StyleSheet.create({
  ...
  startText: { fontSize: 13, fontWeight: '600', color: '#3b82f6' },
