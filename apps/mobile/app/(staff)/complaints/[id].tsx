...
const styles = StyleSheet.create({
  ...
  acceptBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#3b82f6', borderRadius: 12, padding: 14, marginBottom: 10 },
  ...
  actionLabel: { fontSize: 15, fontWeight: '500', color: '#3b82f6' },
