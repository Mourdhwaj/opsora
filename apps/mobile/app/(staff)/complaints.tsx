...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 16, fontFamily: theme.font.semiBold, color: theme.colors.text, marginBottom: 4 },
  desc: { fontSize: 13, color: theme.colors.textSecondary, marginBottom: 8 },
  metaRow: { flexDirection: 'row', justifyContent: 'space-between', paddingTop: 8, borderTopWidth: 1, borderTopColor: theme.colors.borderLight, marginBottom: 8 },
  meta: { fontSize: 12, color: theme.colors.textMuted },
  actions: { flexDirection: 'row', gap: 8 },
  acceptBtn: { flex: 1, paddingVertical: 8, borderRadius: 8, backgroundColor: theme.colors.infoSurface, alignItems: 'center' },
  acceptText: { fontSize: 13, fontFamily: theme.font.semiBold, color: theme.colors.primary },
  resolveBtn: { flex: 1, paddingVertical: 8, borderRadius: 8, backgroundColor: theme.colors.successSurface, alignItems: 'center' },
  resolveText: { fontSize: 13, fontFamily: theme.font.semiBold, color: theme.colors.success },
});
