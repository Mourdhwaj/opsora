...
const styles = StyleSheet.create({
  ...
  dateRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, backgroundColor: theme.colors.surface, borderBottomWidth: 1, borderBottomColor: theme.colors.borderLight },
  dateArrow: { fontSize: 20, color: theme.colors.primary, padding: 8 },
  dateCenter: { alignItems: 'center' },
  dateText: { fontSize: 16, fontFamily: theme.font.bold, color: theme.colors.text },
  todayBadge: { fontSize: 11, fontFamily: theme.font.semiBold, color: theme.colors.primary, marginTop: 2 },
  progressSection: { padding: 16 },
  progressBar: { height: 8, backgroundColor: theme.colors.border, borderRadius: 4, overflow: 'hidden', marginBottom: 6 },
  progressFill: { height: '100%', backgroundColor: theme.colors.success, borderRadius: 4 },
  progressText: { fontSize: 13, fontFamily: theme.font.semiBold, color: theme.colors.textSecondary, textAlign: 'center' },
  categorySection: { marginBottom: 16 },
  categoryTitle: { fontSize: 13, fontFamily: theme.font.bold, color: theme.colors.textMuted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8, paddingHorizontal: 4 },
  itemCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surface, borderRadius: 10, padding: 14, marginBottom: 6, gap: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 2, elevation: 1 },
  itemDone: { backgroundColor: theme.colors.successSurface },
  checkbox: { width: 24, height: 24, borderRadius: 12, borderWidth: 2, borderColor: theme.colors.borderMedium, justifyContent: 'center', alignItems: 'center' },
  checkboxDone: { backgroundColor: theme.colors.success, borderColor: theme.colors.success },
  checkmark: { color: theme.colors.surface, fontSize: 14, fontFamily: theme.font.bold },
  itemTitle: { fontSize: 15, fontFamily: theme.font.medium, color: theme.colors.text, flex: 1 },
  itemTitleDone: { textDecorationLine: 'line-through', color: theme.colors.textMuted },
});
